casper.test.begin('Students view (all students)', 12, function suite(test) {
    ...
    casper.then(function () {
        ...
        test.assertEquals($('tr:contains(Student 1)').find(':nth-child(3)').html(), '2', 'has course count 2 for "Student 1"');
        test.assertEquals($('tr:contains(Student 2)').find(':nth-child(3)').html(), '3', 'has course count 3 for "Student 2"');
        test.assertEquals($('tr:contains(Student 3)').find(':nth-child(3)').html(), '4', 'has course count 4 for "Student 3"');
    });
